...
public class The_Second_Scene extends SimpleApplication {
    ...
    public static void main(String[] args) {
        The_Second_Scene app = new The_Second_Scene();
        app.start();
    }
    ...
    public void add_park(String path){
        ...
        float[] position = new float[] {1094f,8f,1619f };
    ...
    public void add_cross(){
        float[] cross_size = {17f,0.01f,17f};
        float[] cross_raod_size = {17f,0.01f,12.0f};
   ...
   public void T_cross_init(){
    ...
    public void fence_init(int num){
        ...
        add_Fence(fn[0]);
        fn[1].setLocalTranslation(0f, -0.1f, -685f);
        add_Fence(fn[1]);
        fn[2].setLocalTranslation(1094f, -0.1f, 392f);
        add_Fence(fn[2]);
        fn[3].setLocalTranslation(185f, -0.1f, 207f);
        fn[3].rotate(0f, 1.5707963f, 0f);
        add_Fence(fn[3]);
        fn[4].setLocalTranslation(185f, -0.1f, 1301f);
        fn[4].rotate(0f, 1.5707963f, 0f);
        add_Fence(fn[4]);
    }
    ...
    public void tree_init(int num){
        ...
        tr[0].setLocalTranslation(-18f, -0.1f, 330f);
        add_Tree(tr[0]);
        tr[1].setLocalTranslation(-18f, -0.1f, -750f);
        add_Tree(tr[1]);
        tr[2].setLocalTranslation(1076f, -0.1f, 330f);
        add_Tree(tr[2]);
        tr[3].setLocalTranslation(90f, -0.1f, 225f);
        tr[3].rotate(0f, 1.5707963f, 0f);
        add_Tree(tr[3]);
        tr[4].setLocalTranslation(90f, -0.1f, 1319f);
        tr[4].rotate(0f, 1.5707963f, 0f);
        add_Tree(tr[4]);
//        
    ...
    public void add_Grand(PhysicsSpace physicsSpace){
        Texture grand_tex = tex_init("Scenes/Task/four/grass.png", true);
    ...
    public void add_mainroad(int num){
        float[] main_size = {17f,0.01f,480f};
        Texture road_tex = tex_init("Scenes/Task/four/ML2.jpg", true);
        float[] rmian_scale = {33f,2f};
        ...
        float[] first_position = {0f,0.01f,-340f};
        add_sp(main_road1, first_position, init_rotation);
        float[] last_postion = {1094f, 0.01f, 1848f};
        ...
        for(int i = 0; i<num; i++){
            ...
            if( i %2 == 1){
                ...
                float[] road_position = {first_cross_position[1]+547f, first_cross_position[1], first_cross_position[2]+547*(i-1)};
                add_sp(main_road, road_position, road_roatation);
            }
            else{
                float[] road_position = {first_cross_position[1]+547*(i), first_cross_position[1], first_cross_position[2]+547f};
    ...
    public void add_cross(float[] cross_size,float[] road_size,float[] position){
        ...
        Texture tex_cross = tex_init("Scenes/Task/four/cross.jpg", true);
        ...
        Texture soild_line_tex = tex_init("Scenes/Task/four/solid_line.jpg", true);
        float[] soild_line_size = {17f,0.01f,13f};
        float cha2 = soild_line_size[2] +cha + road_size[2];
        float[] soild_scale = {2,2};
        Texture tex_crossr = tex_init("Scenes/Task/four/crossing.jpg", true);
        ...
        for(int i = 0;i<4;i++){
            ...
            if(i % 2 == 0 ){
               i+=2;
               float[] crossr_roatation = {0,i*1.5707963f,0};
               i-=2;
    ...
    public void add_T_cross(float[] T_cross_size,float[] T_road_size, Node N){
        ...
        Texture  Tcross_tex = tex_init("Scenes/Task/four/cross.jpg", true);
        ...
        float[] soild_scale = {2,2};
        Texture Tline_tex1 = tex_init("Scenes/Task/four/s2_new.jpg", true);
        Spatial cross_line1 = Spatial_init(T_road_size, scaleTextureCoordinates, Tline_tex1);
        Texture Tline_tex2 = tex_init("Scenes/Task/four/s3_new.jpg", true);
        Spatial cross_line2 = Spatial_init(T_road_size, scaleTextureCoordinates, Tline_tex2);
        Texture Tline_tex3 = tex_init("Scenes/Task/four/s4_new.jpg", true);
   ...
   public void Speed_limit(String path){
        ...
        Speed[1] = Load_model("Scenes/Task/speedLimit70/speedLimit70.scene", 2f, 2f, 2f);
        Speed[1].rotate(0f, 3.1415926f, 0);
        Speed[3] = Load_model("Scenes/Task/speedLimit70/speedLimit70.scene", 2f, 2f, 2f);
        Speed[3].rotate(0f, 3.1415926f, 0);
        add_sp(Speed[0], -19f, -1.1f, -400f, init_rotation);
        add_sp(Speed[1], -19f, -1.1f, 276f, init_rotation);
        add_sp(Speed[2], 1076f, -1.1f, 276f, init_rotation);
        float[] rotation ={0, 1.5707963f,0f}; 
        add_sp(Speed[3], 158f, -1.1f, 226f, rotation);
        add_sp(Speed[4], 158f, -1.1f, 1319f, rotation);
        Speed[5] = Load_model("Scenes/Task/speedLimitEnd/speedLimitEnd.scene", 2f, 2f, 2f);
        Speed[5].rotate(0f, 1.57059f, 0);
        add_sp(Speed[5], -19f, -1.1f, 1085f, rotation);
        Speed[6] = Load_model("Scenes/Task/speedLimitEnd/speedLimitEnd.scene", 2f, 2f, 2f);
        Speed[6].rotate(0f, 3.1415926f, 0);
        add_sp(Speed[6], 850f, -1.1f, 226f, rotation);
   }
    
    
    public void Guidep(){
       float[] position1 = new float[] {-19f,-1.1f,1176f};
       float[] rotation1 = new float[] {0f,-1.5707963f,0f};
    ...
    public void add_Tree(Node T){
        ...
        for(int i = 0; i<11;i++){
            ...
            tree[i].rotate(0f, 1.5707963f, 0f);
            tree[i].setLocalTranslation(0.0f, 0.2f, i*80f);
            T.attachChild(tree[i]);
        }
        for(int i = 11; i<22;i++){
            tree[i] = Load_model("Scenes/Task/Tree 02/Tree.obj", 2f, 2f, 2f);
            tree[i].rotate(0f, 1.5707963f, 0f);
            tree[i].setLocalTranslation(36f, 0.2f, (i-11)*80f);
            T.attachChild(tree[i]);
        }
    }
